        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="productEdit" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <img :src="form.newImage" id="imgHide" style="width:80px;height:100px;display:none" class="image-fluid mb-1">
                                </div>

                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button class="btn btn-info"><i class="fas fa-plus"></i> Update Product</button>
                                    </div>
                                </div>
                            </div>
                        </form>
